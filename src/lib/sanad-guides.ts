  ...
  steps: [
    {
      ...
      route: null,
      message: { en: 'Welcome. I will guide you through building your first business plan.', ar: 'مرحباً. سأرشدك خلال بناء خطتك التجارية الأولى.' },
      arrowDirection: 'down',
      spotlight: true,
      glowTarget: true,
    ...
    },
    {
      ...
      route: null,
      message: { en: 'Open Planner. This is where your business roadmap is built.', ar: 'افتح المخطط. هنا يُبنى مسار أعمالك.' },
